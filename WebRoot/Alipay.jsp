...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<% 
			String order_num=new String(request.getParameter("order_num").getBytes("ISO8859-1"),"UTF-8");
			String phone=new String(request.getParameter("phoneForSubmit").getBytes("ISO8859-1"),"UTF-8");
			String amount=new String(request.getParameter("price").getBytes("ISO8859-1"),"UTF-8");
			String name=new String(URLDecoder.decode(request.getParameter("name"),"UTF-8").getBytes("ISO8859-1"),"UTF-8");
		%>
		<%
  		...
  		<%
  		 ...
  		 %>
		<form name=alipayment action="turn" method=post>
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="order_num" value="<%=order_num %>"/>
						<input type="hidden" id="WIDout_trade_no" name="phoneForSubmit" value="<%=phone %>" />
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="电影票"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
					...
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="<%=name %>"/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
